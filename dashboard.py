...
""", unsafe_allow_html=True)
st.sidebar.image('https://github.com/Rendika7/Dashboard-Sentiment-Analysis/blob/main/Source/TELKOM-UNIVERSITY-LOGO-HORIZONTAL.png', caption='Tel-U Surabaya',width=150 , use_column_width=False)  
...
<div style="background-color:#333; padding-bottom:15px; padding-left:30px; padding-right:30px">
    ...
    st.metric(Name="Miranthy Pramita Ningtyas", Jabatan=LUPA, Icon="🧑‍🎨")
    
    with Anggota4: [1206220017]
    st.metric(Name="Shabiha Rahma Fauziah", Jabatan= LUPA, Icon="🧛")
    
    with Anggota5: [1206220009]
    st.metric(Name="Halim Arif Cahyono", Jabatan=LUPA, Icon="🧑‍✈️")
</div>
"""
